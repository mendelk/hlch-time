...
function SunRiseSetH(year,month,day,latitude,longitude) {
...
var cHA3=(sind(-8.83)-sind(latitude)*sind(sDec))/(cosd(latitude)*cosd(sDec));
  var HA3=acosd(cHA3);
  HA3=rev(HA3)/15;
  // return rise and set times
  return new Array((0.0),(MT+HA0+4.0/60.0),(MT+HA0),(MT+HA2),(MT+HA3));
}
