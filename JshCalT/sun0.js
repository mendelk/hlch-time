...
function SunRiseSet0(year,month,day,latitude,longitude) {
  ...
  var cHArb=(sind(-2.10)-sind(latitude)*sind(sDec))/(cosd(latitude)*cosd(sDec)); //6 min  
  var HArb=acosd(cHArb);
  HArb=rev(HArb)/15;
...
//alert(HA0/12+"\n"+0.5)
  return new Array((MT-HA0),(MT+HA0),(MT-HA0/2.0),(MT-HA0/3.0),MT,(MT+HA0/12),(MT+HA0*7.0/12.0),(MT+HA0*19.0/24.0),(MT-HA00),(MT-HA01),(MT+HArb),(MT-HA0/6.0));
}
